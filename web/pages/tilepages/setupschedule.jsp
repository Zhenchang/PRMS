            ...
            <center>
                <table cellpadding=4 cellspacing=2 border=0>
                    <tr>
                        ...
                        <td><input id="duration" type="text" name="duration" value="${param['duration']}" maxlength=20></td> </td>
                    </tr>
                    <tr>
                        <td><fmt:message key="label.crudschedule.dateOfProgram" /></td>
                        <td><input id="dateOfProgram" type="text" name="dateOfProgram" value="${param['dateOfProgram']}" maxlength=20></td>
                    </tr>
                    <tr>	
                        <td><fmt:message key="label.crudschedule.startTime" /></td>
                        <td><input type="text" name="startTime" value="${param['startTime']}" maxlength=20></td>
                    </tr>
                    <tr>
